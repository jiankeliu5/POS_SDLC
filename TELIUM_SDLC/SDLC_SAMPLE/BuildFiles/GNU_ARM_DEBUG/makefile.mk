...
-I"Inc" \
-I"Src/porting/inc" \
-I"../../Vx510_SDLC/SOURCE/app/inc" \
-I"../../Vx510_SDLC/SOURCE/lib/Inc" \
...
ifneq ($(MAKECMDGOALS), clean)
-include $(OBJ_PATH)/porting.d
endif
$(OBJ_PATH)/porting.o: Src/porting/porting.c $(DEPENDENCIES) $(EXTRA_DEPENDENCIES)
	@$(PRINTF) "'Src/porting/porting.c' compilation in progress...\n"
	$(CC) $(CC_OPTS) -MMD -MP -o "$@" "$<"
ifeq ($(MAKECMDGOALS), $(OBJ_PATH)/porting.o)
	@$(PRINTF) "done!\n"
endif

ifneq ($(MAKECMDGOALS), clean)
-include $(OBJ_PATH)/aplic.d
endif
$(OBJ_PATH)/aplic.o: C:/Projetos/SDLC_SAMPLE/Vx510_SDLC/SOURCE/app/aplic.c $(DEPENDENCIES) $(EXTRA_DEPENDENCIES)
	@$(PRINTF) "'C:/Projetos/SDLC_SAMPLE/Vx510_SDLC/SOURCE/app/aplic.c' compilation in progress...\n"
	$(CC) $(CC_OPTS) -MMD -MP -o "$@" "$<"
ifeq ($(MAKECMDGOALS), $(OBJ_PATH)/aplic.o)
	@$(PRINTF) "done!\n"
endif

ifneq ($(MAKECMDGOALS), clean)
-include $(OBJ_PATH)/app_sys.d
endif
$(OBJ_PATH)/app_sys.o: C:/Projetos/SDLC_SAMPLE/Vx510_SDLC/SOURCE/lib/app_sys.c $(DEPENDENCIES) $(EXTRA_DEPENDENCIES)
	@$(PRINTF) "'C:/Projetos/SDLC_SAMPLE/Vx510_SDLC/SOURCE/lib/app_sys.c' compilation in progress...\n"
	$(CC) $(CC_OPTS) -MMD -MP -o "$@" "$<"
ifeq ($(MAKECMDGOALS), $(OBJ_PATH)/app_sys.o)
	@$(PRINTF) "done!\n"
endif
