...
/* ponto de entrada para SAMPLE_SDLC TELIUM compartilhado entre plataformas --> formato STAND_ALONE, desnecessario o uso do manager para gerencia de X aplicacoes */ 
...
static service_desc_t Services[] = {
    { 0, GIVE_YOUR_DOMAIN, (SAP)Main, SERVICES_DEFAULT_PRIORITY },
    { 0, AFTER_RESET, (SAP)Main, SERVICES_DEFAULT_PRIORITY },
    { 0, IS_NAME, (SAP)Main, SERVICES_DEFAULT_PRIORITY },
    { 0, IS_STATE, (SAP)Main, SERVICES_DEFAULT_PRIORITY }

#ifdef NAO_UTILIZADO
    { 0, IDLE_MESSAGE, (SAP)Main, SERVICES_DEFAULT_PRIORITY },
    { 0, MORE_FUNCTION, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, KEYBOARD_EVENT, (SAP)Main, SERVICES_DEFAULT_PRIORITY },
    { 0, STATE, (SAP)Main, SERVICES_DEFAULT_PRIORITY },
    { 0, CONSULT, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, MCALL, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, IS_TIME_FUNCTION, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, TIME_FUNCTION, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, IS_CHANGE_INIT, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, MODIF_PARAM, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, IS_EVOL_PG, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, IS_DELETE, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, FILE_RECEIVED, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, MESSAGE_RECEIVED, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, IS_CARD_SPECIFIC, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, CARD_INSIDE, (SAP)Main, SERVICES_DEFAULT_PRIORITY },
    { 0, IS_FOR_YOU_AFTER, (SAP)Main, SERVICES_HIGH_PRIORITY },
    { 0, DEBIT_NON_EMV, (SAP)Main, SERVICES_HIGH_PRIORITY }
#endif
};
...
int is_state(NO_SEGMENT no, void *p1, S_ETATOUT *param_out)
{
	...
	main_telium ();							/* aplicacao SAMPLE_SDLC! --> STAND_ALONE, portanto sem retorno */
...
int give_interface(unsigned short AppliNum, void *p1, void *p2)
{
    ...
    for(i = 0; i < (int)(sizeof(Services) / sizeof(Services[0])); i++)
	{
		...
		Services[i].priority = SERVICES_DEFAULT_PRIORITY;
	}
